...
module.exports = function (plop) {
  ...
  plop.setGenerator('app', {
    description: 'Adds a new app to cib core',
    prompts: [
      {
        type: 'input',
        name: 'name',
...
const {{titleCaseWithoutSpace name}}App = React.lazy(() => import('@cib/{{name}}'));`
      },
      {
        type: 'modify',
        path: 'apps/core/src/App.js',
...
`
  ...
  plop.setGenerator('library', {
    description: 'Adds a new library to cib core',
    prompts: [
      {
        type: 'input',
        name: 'name',
